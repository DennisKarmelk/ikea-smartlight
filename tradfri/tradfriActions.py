...
def tradfri_color_light(hubip, userid, securityid, lightbulbid, value):
...
def tradfri_power_group(hubip, userid, securityid, groupid, value):
    """ function for power on/off tradfri lightbulb """
...
def tradfri_dim_group(hubip, userid, securityid, groupid, value):
    """ function for dimming tradfri lightbulb """
